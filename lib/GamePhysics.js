...
GamePhysics.prototype.computeState = function(balls, magnets){
  var self = this;
  balls.forEach(function(ball){
    self.computeBallState(ball);
  });
...
GamePhysics.prototype.computeBallState = function(ball, magnets){
  ...
  var center = new Vector(this.dimensions.x / 2 , this.dimensions.y / 2);
...
GamePhysics.prototype.checkWallCollision = function(ball){
  var collision = {};
  collision.maxX = this.dimensions.x - ball.radius;
  collision.maxY = this.dimensions.y - ball.radius;
